...
const Info = function(props) {
  var editorsChoiceLogo = 'https://icons-987654321.s3-us-west-1.amazonaws.com/editchoicefull.png';
  var editorsChoice = 'Editors\' Choice';

  if (props.app.editorChoice === true) {
    editorsChoiceLogo = 'https://icons-987654321.s3-us-west-1.amazonaws.com/editchoicefull.png';
